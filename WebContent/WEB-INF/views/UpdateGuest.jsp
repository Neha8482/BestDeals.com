...
<body>
	...
	<div class="container">
		<form class="update-form" action="http://localhost:8080/HotelManagementSpringProject/updateUser/${guest.guestId}" method="post">
			<h1>Edit Details</h1>
				<div class="form-group">
				<label for="guestName">ID</label>
				<input class="form-control" type="text" value=${guest.guestId} name="guestId" placeholder="Enter name">
			</div>
			<div class="form-group">
