		...
		<div class="row shift-text-top">
  		...
  		<div class="row shift-top">
  			<div class="col-lg-12 text-center">
  				<a href="http://localhost:8080/HotelManagementSpringProject/HotelLogin">
  				<button class="btn btn-lg btn-success shift-right">Hotel Provider</button></a>
  			
  				<a href="http://localhost:8080/HotelManagementSpringProject/UserLogin">
  				<button class="btn btn-lg btn-success shift-right">Customer</button></a>
  				
  				<a href="http://localhost:8080/HotelManagementSpringProject/hotels">
