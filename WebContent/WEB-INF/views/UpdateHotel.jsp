...
<body>
	<div class="row">
		...
		<div class="logout-pos">
			<a href="http://localhost:8080/HotelManagementSpringProject/HotelLogin"><button class="btn btn-danger btn-lg">Log Out</button></a>
		</div>
	</div>
	<div class="container">
		<form class="registration-page" action="http://localhost:2200/HotelManagementSpringProject/updateHotel/${hotel.hotelId}" method="post">
