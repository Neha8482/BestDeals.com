...
<body>
	<div class="row">
		...
		<div class="logout-pos">
			<a href="http://localhost:8080/HotelManagementSpringProject/UserLogin"><button class="btn btn-danger btn-lg">Log Out</button></a>
		</div>
		<div class="logout-pos">
			<a href="http://localhost:8080/HotelManagementSpringProject/UserProfile/${id}"><button class="btn btn-danger btn-lg">Update Profile</button></a>
		</div>
		<div class="logout-pos">
			<form action="http://localhost:8080/HotelManagementSpringProject/userBookingDetails" method="post">
	...
	<div class="row">
		<div class="search-by-city text-center">
			<form action="http://localhost:8080/HotelManagementSpringProject/searchHotels" method="post">
