...
<body>
	<div class="container">
		<form class="registration-form" action="http://localhost:8080/HotelManagementSpringProject/hotel" method="post">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input type="email" class="form-control" name="email" id="email" placeholder="Enter hotel email" required/>
						</div>
					</div>
				</div>
				<div class="row">	
