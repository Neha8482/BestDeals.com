...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 ">
				<form action="http://localhost:8080/HotelManagementSpringProject/user" method="post" class="login-form">
					<h1>Log in </h1>
					<br/>
				...
				<a  href="http://localhost:8080/HotelManagementSpringProject/GuestForm">Don't have an account Register here</a>
			</div>
		</div>
	</div>
</body>
