...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 ">
				<form action="http://localhost:8080/HotelManagementSpringProject/manager" method="post" class="login-form">
					<h1>Log in </h1>
					<br/>
				...
				<a href="http://localhost:8080/HotelManagementSpringProject/HotelForm">Don't have an account Register here</a></p>
			</div>
		</div>
	</div>
</body>
